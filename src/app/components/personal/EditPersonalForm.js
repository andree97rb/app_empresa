...
import 'app/components/personal/EditPersonalForm.css';
...
const EditPersonalForm = ({
    ...
    return (
        <div className="editPersonalForm-container">
            <div className="editPersonalForm-title">Edit Personal</div>
            <Form noValidate onSubmit={onSubmit} className="editPersonalForm-inputs">
                <Row>
                    <Col sm={6}>
                ...
                <Row className="editPersonalForm-buttons">
                    <Button type="submit" className="editPersonalForm-btn-edit">
                        Update
                    </Button>
                    <Link to="/personalList" className="editPersonalForm-btn-cancel">
                        Cancel
                    </Link>
                </Row>
            </Form>
